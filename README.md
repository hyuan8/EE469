...
You can figure out how to initially set it up. The .gitignore file is very important, check that it is in your local folder before doing anything. I used HTTPS and not SSH.
